...
store.dispatch(changeName('Cristian'));
...
store.dispatch(addMovie('Terminator', 'Fiction'));

store.dispatch(addMovie('Back To The Future', 'Fiction'));

store.dispatch(addMovie('Happie Feet', '3D'));
